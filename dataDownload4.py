    ...
    def retrbinaryCallback(self):
        ...
        if len(ftpSettings.downloadCache.cache[catchIndex]) > ftpSettings.cacheLen or ftpSettings.downloadList.finLen[fileNameIndex] == ftpSettings.downloadList.dataLen[fileNameIndex]:
            ...
            if os.path.getsize(saveFileDir) == ftpSettings.downloadList.finLen[fileNameIndex]:
                ...
                downloadList = ftpSettings.downloadList
                raise NameError("e8: file and log are inconsistent")
            ...
            if downloadList.time[fileNameIndex] == lastTime:
                ...
                lastTime = lastTime - 1
            print("wrinting " + downloadList.fileName[fileNameIndex] + "\tSpeed: " + str(round(ftpSettings.cacheLen/((downloadList.time[fileNameIndex]-lastTime)*1000), 2)) +"k/s")
